...
const Hero = () => {
  return (
    <>
      {/* this about section is i am using as a hero section  */}
      <About />
      <section
        id="home"
        className="relative overflow-hidden bg-[#011D49]  pt-[120px] dark:bg-dark-2 md:pt-[130px] lg:pt-[50px]"
      >
          ...
          <div className="-mx-4 flex flex-wrap items-center">
            ...
            <div className="w-full px-4">
              ...
              >
                <div className="mt-16">
                  <Image
                    src="/images/hero/MahasharshtraMAP.png"
                    alt="hero"
